...
class BasicBlock(nn.Sequential):
    def __init__(
        ...
        bn=True, act=nn.LeakyReLU(negative_slope=0.01, inplace=True)):
...
class LowRankLayer_dilation(nn.Module):
    ...
    def forward(self, x, eps=1e-6):
        ...
        out = self.tail_conv(UV.contiguous())+res
...
class NonLocalLayer_dilation(nn.Module):
    ...
    def forward(self, x, eps=1e-6):
        ...
        out = out.view(batch, self.out_channels, height, width).contiguous()
